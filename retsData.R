data1 <- read.csv("C:/Users/ahsu/Desktop/Data Stuff/data from mlslistings/Parakeet/SCC20Columns 09 to 11.csv", header = TRUE, skip= 1)
data2 <- read.csv("C:/Users/ahsu/Desktop/Data Stuff/data from mlslistings/Parakeet/SCC20Columns 12 to 16.csv", header = TRUE, skip= 1)
datascc <- rbind(data1, data2)


data3 <- read.csv("C:/Users/ahsu/Desktop/Data Stuff/data from mlslistings/Parakeet/ParakeetSMC0716.csv", header = TRUE, skip= 1)
data4 <- read.csv("C:/Users/ahsu/Desktop/Data Stuff/data from mlslistings/Parakeet/ParakeetSMC0206.csv", header = TRUE, skip= 1)
datasmc <- rbind(data1, data2)


data <- rbind(datasmc, datascc)

data <- read.csv("C:/Users/ahsu/Desktop/Data Stuff/data from mlslistings/Parakeet/MenloParkSales303.csv", header = TRUE, skip= 1)
...
data[,"Out.Of.Area.Agent"] <- data[,"Out.Of.Area.Agent1"] 
# data[,"Out.Of.Area.Agent"] <- rep(0, nrow(data))
